...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (<div className="p-5 dark:bg-black/10 bg-black/5 shadow rounded-2xl">
    ...
    <div className="grid grid-cols-2 grid-rows-1 max-md:grid-cols-1 gap-5 my-8">
        <div>
            { project.data.imgPath && 
                <a className="inline-block mb-5" target="_blank" href={project.data.deploymentLink ? project.data.deploymentLink : project.data.repoLink}>
                    <img className="rounded-2xl max-md:w-auto" src={project.data.imgPath} width="500"/>
                </a> 
            }
